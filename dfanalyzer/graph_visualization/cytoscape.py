...
class CytoGraph:
    ...
    def get_style(self, style_name):
        '''
        Input: style_name (string as filter identifier)
        Output: style  for cytoscape visualization
        '''
        if style_name == 'default':  # this will check if the filters are working properly
            style = [
                {
                    'selector': 'nodes',
                    'style': {
        ...
        elif style_name == 'directed':  # this will check if the filters are working properly
              style = [
                {
                    'selector': 'nodes',
                    'style': {
                ...
                # },
                {
                    ...
                    'selector': 'edge[back]',
                    'style': {
                        'line-color': 'red',  # Red color for back edges
                        'target-arrow-color': 'red'  # Red arrow color for back edges
                    }
                },
                # {
                    # 'selector': f'node[degree>2]',
